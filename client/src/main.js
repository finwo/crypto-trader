...
import PagePortfolio  from './page/portfolio/edit.vue';
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/portfolio/:uuid', component: PagePortfolio , name: 'Portfolio' , meta: { nav: false, icon: 'account_balance_wallet' } },
